...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table','laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${mao}/logInfo/loadAllLogInfo.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${mao}/logInfo/loadAllLogInfo.action?" + params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(logInfoTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.loginname + '】这个日志么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${mao}/logInfo/deleteLogInfo.action", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些日志么？', function (index) {
                //向服务端发送删除指令
                $.post("${mao}/logInfo/deleteBatchLogInfo.action",params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
