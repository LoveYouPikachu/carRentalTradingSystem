...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns = table.render({
            ...
            , url: '${mao}/role/loadAllRole.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${mao}/role/loadAllRole.action?" + params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(roleTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rolename + '】这个角色么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${mao}/role/deleteRole.action", {roleid: data.roleid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function openUpdateRole(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${mao}/role/updateRole.action";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些角色么？', function (index) {
                //向服务端发送删除指令
                $.post("${mao}/role/deleteBatchRole.action",params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
        ...
        function openselectRoleMenu(data) {
            ...
            mainIndex=layer.open({
                ...
                yes:function (index, layero) {
                    ...
                    //保存角色和菜单的关系
                    $.post("${mao}/role/saveRoleMenu.action",params,function (obj) {
                        layer.msg(obj.msg);
                        //关闭弹出层
                        layer.close(mainIndex);
                    })
                ...
                success:function (index) {
                    ...
                    menuTree = dtree.render({
                        ...
                        checkbarType:"all",
                        checkbarData:"choose",
                        url: "${mao}/role/initRoleMenuTreeJson.action?roleid="+data.roleid
                    });
