...
<head>
    ...
    <link rel="icon" href="${mao}/static/favicon.ico">
    <link rel="stylesheet" href="${mao}/static/layui/css/layui.css" media="all"/>
    <link rel="stylesheet" href="${mao}/static/css/index.css" media="all"/>
    <style>
        @font-face {
            font-family: "seraph";
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${mao}/static/images/userface2.jpg" class="layui-nav-img userAvatar"
                                                width="35" height="35"><cite
                            class="adminName">${user.realname}</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${mao}/static/page/user/userInfo.html"><i
                                class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="${mao}/static/page/user/changePwd.html"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${mao}/static/images/userface2.jpg" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${mao}/static/page/main.html">
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${mao}/desk/toDeskManager.action"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2021mao</span></p>
    </div>
</div>
...
<script type="text/javascript" src="${mao}/static/layui/layui.js"></script>
<script type="text/javascript" src="${mao}/static/js/cache.js"></script>
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${mao}/menu/loadIndexleftMenuJson.action" //获取菜单json地址
        });
