...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${mao}/rent/loadAllRent.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${mao}/rent/loadAllRent.action?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(rentTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rentid + '】这个出租单么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${mao}/rent/deleteRent.action", {rentid: data.rentid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
                ...
                window.location.href="${mao}/stat/exportRent.action?rentid="+data.rentid;
        ...
        function openUpdateRent(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${mao}/rent/updateRent.action";
                }
            });
        }
