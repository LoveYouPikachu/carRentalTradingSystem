    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '${mao}/car/loadAllCar.action?isrenting=0' //数据接口
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${mao}/rent/checkCustomerExist.action", params, function (obj) {
        ...
        function openRentCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $.get("${mao}/rent/initRentFrom.action",{
                        identity:identity,
                        price:price,
                        carnumber:carnumber
                    },function (obj) {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("${mao}/rent/saveRent.action", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层
