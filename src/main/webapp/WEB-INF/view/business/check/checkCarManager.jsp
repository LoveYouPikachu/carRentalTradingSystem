...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${mao}/check/checkRentExist.action", {rentid: rentid}, function (obj) {
        ...
        function initCheckFormData(rentid) {
            $.post("${mao}/check/initCheckFormData.action",{rentid:rentid},function (obj) {
                //检查单
                var check=obj.check;
                ...
                $("#car_carimg").attr("src","${mao}/file/downloadShowFile.action?path="+car.carimg);
            })
        }
        //保存
        form.on("submit(doSubmit)",function () {
            var params = $("#checkFrm").serialize();
            $.post("${mao}/check/saveCheck.action",params,function (obj) {
                layer.msg(obj.msg);
                $("#content").hide();
            })
            return false;
